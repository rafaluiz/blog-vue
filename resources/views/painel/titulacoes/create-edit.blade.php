          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/painel/titulacoes')}}">Titulações</a></li>
                  ...
                  <div class="card-body">
                                          ...
                                          <div class="form-body">
                                            <h2 class="form-section">
                                             ...
                                             @if( isset($data) )
                                                 {!! Form::model($data, ['route' => ['titulacoes.update', $data->id], 'class' => 'form', 'files' => true, 'method' => 'PUT']) !!}
                                             @else
                                                 {!! Form::open(['route' => 'titulacoes.store', 'class' => 'form', 'files' => true]) !!}
                                             @endif
                                            <div class="row">
