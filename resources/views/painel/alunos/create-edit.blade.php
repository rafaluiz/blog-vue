                  ...
                  <div class="card-body">
                                          ...
                                          <div class="form-body">
                                            <h2 class="form-section">
                                             ...
                                             @if( isset($data) )
                                                 {!! Form::model($data, ['route' => ['alunos.update', $data->id], 'class' => 'form', 'files' => true, 'method' => 'PUT']) !!}
                                             @else
                                                 {!! Form::open(['route' => 'alunos.store', 'class' => 'form', 'files' => true]) !!}
                                             @endif
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-md-6">
                                                  ...
                                                  <div class="col-md-6">
                                                    ...
                                                    <select name="id_instituicoe" class="form-control">
                                                    <option value="">Instituições</option>
                                                    @foreach( $instituicoes as $instituicoe)
                                                    <option value="{{$instituicoe->id}}"
                                                    @if( isset($data->id_instituicoe) && $data->id_instituicoe == $instituicoe->id )
                                                    selected
                                                    @endif
                                                    >{{$instituicoe->name}}</option>
                                                    @endforeach
                                                      </select>
                                                    </div>
                                                      </div>
                                                      ...
                                                      <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Data do Inicio do Processo</label>
                                                          {!! Form::text('inicioprocesso', null, ['class="form-control date-mask to-date" placeholder="dd/mm/aaaa"']) !!}
                                                        </div>
                                                      </div>

                                                      <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Data da Previssao do Projeto</label>
                                                          {!! Form::text('previsaoprojeto', null, ['class="form-control date-mask to-date" placeholder="dd/mm/aaaa"']) !!}
                                                        </div>
                                                      </div>

                                                      <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Data da Previssão final do Projeto</label>
                                                          {!! Form::text('previsaofinal', null, ['class="form-control date-mask to-date" placeholder="dd/mm/aaaa"']) !!}
                                                        </div>
                                                      </div>
