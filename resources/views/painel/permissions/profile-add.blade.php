  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Permissão</h3>
                  ...
                  <div class="card-body">
                                          ...
                                          <div class="form-body">
                                            <h2 class="form-section">
                                              Adicionar Novos Perfis a Permissão: <b>{{$permission->name}}
                                             </h2>


                                             {!! Form::open(['route' => ['permissao.profiles.add', $permission->id], 'class' => 'form']) !!}
